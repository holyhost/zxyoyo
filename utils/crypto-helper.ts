...
export const mymd5 = (key: string) => CryptoJS.MD5('my' + key + (key.toString().length * 2) + key + 'key')
export const md5 = (s: string) => CryptoJS.MD5(s)
const enhenceKey = (key: string) => CryptoJS.MD5('zxyo' + key + 'yo' + key.toString().length + '.com')