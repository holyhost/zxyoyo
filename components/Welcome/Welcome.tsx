...
export function Welcome() {
  return (
    <>
      ...
      <Text px={'lg'} c="dimmed" ta="center" size="lg" maw={520} mx="auto" mt="xl">
        ---我们来来回回反反复复，最终还是为了找回小时候一个人哪怕只是玩玩泥巴还能够的那份沉静和认真劲
      </Text>

      <Anchor href='/home'>
        <Text px={'lg'} variant="gradient" ta="center" size="lg" maw={560} mx="auto" mt="xl" gradient={{ from: 'red', to: 'indigo', deg: 156 }}>
